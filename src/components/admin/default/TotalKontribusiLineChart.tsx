...
import {
  lineChartDataTotalKontribusi,
  lineChartOptionsTotalKontribusi,
} from 'variables/charts';
import LineChart from 'components/charts/LineChart';
import ChecklistGreenIcon from 'components/icons/ChecklistGreenIcon';

const TotalKontribusiLineChart = () => {
  return (
    <Card extra="!p-[20px] text-center h-full">
      ...
      <div className="flex h-full w-full flex-row justify-between sm:flex-wrap lg:flex-nowrap 2xl:overflow-hidden">
        <div className="flex flex-col w-1/3 text-left">
          <p className="font-bold text-lightBlue1 mt-8">Total Kontribusi</p>
        ...
        <div className="w-full h-full">
          <LineChart
            chartOptions={lineChartOptionsTotalKontribusi}
            chartData={lineChartDataTotalKontribusi}
          />
        </div>
      </div>
    </Card>
...
export default TotalKontribusiLineChart;
